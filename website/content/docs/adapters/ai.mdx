...
description: "Add AI to TermUI apps with useAI (OpenAI and Anthropic), LocalVectorStore for embedding-based search, and the indexDirectory and chunkText helpers for building a vector store from your own documents."
---
