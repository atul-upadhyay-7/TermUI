...
description: "Integrate command-line tooling into TermUI apps with chalkToTermUI (ANSI pass-through), useExeca (subprocess streaming), and useGit (git operations via simple-git)."
---
