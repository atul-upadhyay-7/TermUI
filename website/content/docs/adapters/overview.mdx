...
description: "Connect TermUI apps to external tools, AI providers, filesystems, and services with @termuijs/adapters. Includes adapters for localStorage, conf, AI (OpenAI/Anthropic), vector store, chalk, execa, git, GitHub, keychain, zod, and dotenv."
---
