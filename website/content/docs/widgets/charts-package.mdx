---
title: "Chart widgets package"
description: "There is no separate @termuijs/charts package. The chart widgets (LineChart, AreaChart, PieChart, BarChart, and more) ship inside @termuijs/widgets. Import them from there."
---
...
import { Box, AreaChart, PieChart, Gauge } from '@termuijs/widgets'
